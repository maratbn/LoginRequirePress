          ...
          ?><hr><input type='submit' value='<?=\__('Update LR Settings',
              ...
              if (\count($arrNonPrivateLoginProtected) > 0) {
                  $renderListOfPosts(
                      ...
                      'These posts will require user login to read, but all logged-in users will be able to read them, hence they\'re not "private".  The login protection can be modified in the table above.',
                      $arrNonPrivateLoginProtected);
              }
